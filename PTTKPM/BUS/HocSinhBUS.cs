...
namespace PTTKPM.BUS
{
    public class HocSinhBUS
    {
        ...
        public HocSinh getStudentIf_BUS2(int maTaiKhoan)
        {
            return hocsinhDAO.getStudentIf(maTaiKhoan);
        }
        ...
        public HocSinh[] getAllStudent_BUS()
        {
            return hocsinhDAO.getAllStudent();
        }

        public HocSinh[] getAllStudentIf_BUS(int maLop, int maMonHoc, int maHocKi)
        {
            return hocsinhDAO.getStudentIf(maLop, maMonHoc, maHocKi);
        }
